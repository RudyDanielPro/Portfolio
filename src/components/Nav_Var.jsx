...
export function Nav_Var() {
  return (
    <nav className="fixed top-0 left-0 z-50 flex flex-row items-center justify-center w-full h-full p-2 space-x-4 text-white md:flex-col md:w-1/6 md:h-screen md:p-4 md:space-x-0 md:space-y-4 bg-slate-950">
